...
![](attachment_jojos-hospital-ransomware/Pasted image 20260409160804.png)

They also left a note:

![](attachment_jojos-hospital-ransomware/Pasted image 20260409160918.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260409161427.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260409161812.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260409162450.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260409162627.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260409163348.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260409163702.png)

We should begin our investigation with the **Employees** table to find the employee who was targeted for initial access:

![](attachment_jojos-hospital-ransomware/Pasted image 20260409164102.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260409164742.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410000415.png)

![](attachment_jojos-hospital-ransomware/Pasted image 20260410000653.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410001619.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410003302.png)

Now let's pivot to these IPs and check if there are other domains associated:

![](attachment_jojos-hospital-ransomware/Pasted image 20260410003702.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410004344.png)

![](attachment_jojos-hospital-ransomware/Pasted image 20260410004504.png)

**37 requests** — that's a lot. Let's check what those requests look like:

![](attachment_jojos-hospital-ransomware/Pasted image 20260410004645.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410004915.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410005127.png)

We have a log from the malicious IP:

![](attachment_jojos-hospital-ransomware/Pasted image 20260410005240.png)

**Username: `andavis`** — and the IP the threat actor used is external.

![](attachment_jojos-hospital-ransomware/Pasted image 20260410005402.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410172955.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410173629.png)

Around **26 requests**:

![](attachment_jojos-hospital-ransomware/Pasted image 20260410173713.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410174105.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410174349.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410174557.png)

**`Raisin_Kane_Free_Meal_Voucher.pdf`**

Now let's check how many users actually downloaded and ran the file:

![](attachment_jojos-hospital-ransomware/Pasted image 20260410174713.png)

**23 out of 24** who reached the site clicked it 😬

The first user clicked at an earlier timeline:

![](attachment_jojos-hospital-ransomware/Pasted image 20260410174836.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410175108.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410175911.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410180037.png)

**The file was executed.** And after execution, Cobalt Strike was also launched:

![](attachment_jojos-hospital-ransomware/Pasted image 20260410180334.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410180924.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410181408.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410181645.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410181949.png)
...
![](attachment_jojos-hospital-ransomware/Pasted image 20260410190337.png)

Then compressed them into a zip before exfiltrating:

![](attachment_jojos-hospital-ransomware/Pasted image 20260410190501.png)
